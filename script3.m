...
[PriceFD, PriceGrid, AssetPrice1, AssetPrice2, Times] = ...
 spreadbyfd(RateSpec, StockSpec1, StockSpec2, Settle, ...
 Maturity, OptSpec, Strike, Corr, ...
    'PriceGridSize', [64 64], 'TimeGridSize', 64, ...
    'AssetPriceMin', [0 0], 'AssetPriceMax', [Smax Smax], ...
    'AmericanOpt', OptionType);

 disp(strcat(['MATLAB ADI: ',num2str(PriceFD)]));